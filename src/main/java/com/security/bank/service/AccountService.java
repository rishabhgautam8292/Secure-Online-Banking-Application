...
public class AccountService {
    ...
    public void updateKycDetails(KycDto kycDto, Long accountId) {
        ...
        if (!kycDto.getName().isEmpty())
            fetechedUser.setName(kycDto.getName());
        if (!kycDto.getAddress().isEmpty())
            fetechedUser.setAddress(kycDto.getAddress());
        if (kycDto.getNumber() != null)
            fetechedUser.setNumber(kycDto.getNumber());
        if (!kycDto.getIdentityProof().isEmpty())
            fetechedUser.setIdentityProof(kycDto.getIdentityProof());
